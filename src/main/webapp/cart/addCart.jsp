		...
		<div class="modern-form">
			...
			<form method="post"
				...
				<div class="form-group">
					<label for="memId">👤 會員編號</label> <input type="text" id="memId"
				...
				<div class="form-group">
					<label for="prodId">📦 商品編號</label> <input type="text" id="prodId"
						name="prodId" class="form-control"
				...
				<div class="form-group">
					<label for="prodN">🔢 商品數量</label> <input type="number" id="prodN"
						...
						value="<%=(cartVO == null) ? "1" : cartVO.getProdN()%>" min="1"
						placeholder="請輸入商品數量" required>
				</div>
