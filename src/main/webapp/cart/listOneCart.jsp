    ...
    <div class="container">
            ...
            <table class="detail-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <span style="color: #764ba2; font-weight: 600;">
                                <%=cartVO.getProdId()%>
                            </span>
                        </td>
                        <td>
                            <span class="data-highlight" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
                                <%=cartVO.getProdN()%> 件
                            </span>
                        </td>
                    </tr>
        ...
        <div class="card">
            ...
            <div class="stats-grid" style="margin-top: 20px;">
                ...
                <div class="stat-card" style="background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%); color: #2c3e50;">
        ...
        <div class="action-section">
            <a href="select_page.jsp" class="nav-button" style="margin-right: 15px;">
                🏠 回到首頁
            </a>
            ...
            <form method="post" action="<%=request.getContextPath()%>/cart/cart.do" style="display: inline-block; margin-right: 15px;">
            ...
            <form method="post" action="<%=request.getContextPath()%>/cart/cart.do" style="display: inline-block;">
                <input type="hidden" name="shopId" value="<%=cartVO.getShopId()%>">
                <input type="hidden" name="action" value="delete">
                <button type="submit" class="btn btn-danger" 
                        onclick="return confirm('確定要刪除這個購物車項目嗎？')">
                    🗑️ 刪除項目
                </button>
            </form>
        </div>
        ...
        <div class="card" style="margin-top: 30px;">
            ...
            <div style="background: #f8f9ff; padding: 20px; border-radius: 10px; margin-top: 15px;">
                <p style="margin: 0; color: #2c3e50; font-size: 1.1rem; line-height: 1.6;">
                    <strong>會員 <%=cartVO.getMemId()%></strong> 在購物車 
                    <strong style="color: #667eea;"><%=cartVO.getShopId()%></strong> 中，
                    選購了商品編號 <strong style="color: #764ba2;"><%=cartVO.getProdId()%></strong>，
                    數量為 <strong style="color: #fa709a;"><%=cartVO.getProdN()%> 件</strong>。
                </p>
            </div>
        </div>
    </div>
